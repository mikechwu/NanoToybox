...
} from '../document/full-history-import';
import type { LoadedCapsuleHistory } from '../document/capsule-history-import';
...
export function buildCapsuleInterpolationCapability(
  ...
  const velocityReason: import('../document/full-history-import').VelocityEndpointReason[] =
    new Array<import('../document/full-history-import').VelocityEndpointReason>(n).fill('restart-misaligned');
  const bracketSafe = new Uint8Array(n);
  const bracketReason: import('../document/full-history-import').BracketReason[] =
    new Array<import('../document/full-history-import').BracketReason>(n).fill('last-frame');
  const hermiteSafe = new Uint8Array(n);
  const window4Safe = new Uint8Array(n);
  const window4Reason: import('../document/full-history-import').WindowReason[] =
    new Array<import('../document/full-history-import').WindowReason>(n).fill('timeline-edge');
