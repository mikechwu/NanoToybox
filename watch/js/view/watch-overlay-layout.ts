 ...
 *
 * Lab drives triad layout through lab/js/runtime/overlay/overlay-layout.ts which measures
 ...
 *
 * Triad sizing replicates lab/js/runtime/overlay/overlay-layout.ts:75-80:
...
export function createWatchOverlayLayout(renderer: WatchRenderer): WatchOverlayLayout {
  ...
  function doLayout() {
    ...
    // Triad sizing — same formulas as lab/js/runtime/overlay/overlay-layout.ts:75-80
