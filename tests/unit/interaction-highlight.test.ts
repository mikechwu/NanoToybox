...
import { resolveInteractionHighlight, type InteractionFeedbackState, type InteractionHighlightPhysicsSurface } from '../../page/js/runtime/interaction-highlight-runtime';
