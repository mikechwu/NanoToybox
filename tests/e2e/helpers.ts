 ...
 * All non-onboarding E2E tests should use this instead of page.goto() for /lab/ paths.
 *
 * @param page - Playwright page
 * @param baseURL - Playwright baseURL (e.g. http://127.0.0.1:4173)
 * @param path - Path relative to baseURL (e.g. '/lab/')
 */
